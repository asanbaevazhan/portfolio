...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#000] text-gray-300'>
      <div>
        {/* <h1 className='text-900 text-[#fff]' style={{ width: '200px' }}>Aizhan</h1> */}
      </div>
        ...
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 '>
            <a
              ...
              target='blank'
              href='https://www.linkedin.com/in/asanbaevazhan/'
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 '>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              target='blank'
              href='https://github.com/asanbaevazhan'
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 '>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='mailto:asanbaevazhan@gmail.com'
            >
